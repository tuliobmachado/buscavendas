...
import br.com.informsistemas.buscavendas.controller.MainActivity;
import br.com.informsistemas.buscavendas.controller.ParceiroActivity;
import br.com.informsistemas.buscavendas.controller.ResumoActivity;
import br.com.informsistemas.buscavendas.adapter.MovimentoAdapter;
import br.com.informsistemas.buscavendas.controller.fragments.MaterialSearchModalFragment;
...
import br.com.informsistemas.buscavendas.model.dao.MovimentoItemDAO;
import br.com.informsistemas.buscavendas.model.dao.MovimentoNFeDAO;
import br.com.informsistemas.buscavendas.model.dao.MovimentoParcelaDAO;
...
import br.com.informsistemas.buscavendas.model.helper.Enums;
...
import br.com.informsistemas.buscavendas.model.tasks.DadosTabelasTask;
import br.com.informsistemas.buscavendas.model.tasks.PedidoTask;
import br.com.informsistemas.buscavendas.model.tasks.RequestSincroniaTask;
import br.com.informsistemas.buscavendas.model.tasks.ResponseSincroniaTask;
import br.com.informsistemas.buscavendas.model.tasks.SincroniaTask;
import br.com.informsistemas.buscavendas.model.utils.RecyclerItemClickListener;
import br.com.informsistemas.buscavendas.viewholder.MovimentoViewHolder;

public class MovimentoFragment extends Fragment implements MovimentoViewHolder.onMovimentoListener {
    ...
    private void setAdapter(List<Movimento> list) {
        movimentoAdapter = new MovimentoAdapter(getActivity(), list, this);
...
//                        break;
    ...
    public void onItemClick(int position){
        if (!isMultiSelect){
            ...
            if (Constants.MOVIMENTO.movimento.sincronizado.equals("T") || Constants.MOVIMENTO.movimento.sincronizado.equals("P")) {
                ...
                if (p != null) {
                    Intent intent = new Intent(getActivity(), ParceiroActivity.class);
    ...
    public void onInfoClick(int position) {
        if (!isMultiSelect) {
            ...
            bundle.putSerializable("movimentonfe", MovimentoNFeDAO.getInstance(getActivity()).findByIdAuxiliar("movimento_id", listMovimento.get(position).id));

            DialogFragment fragmentModal = MovimentoNFeModalFragment.newInstance();
            fragmentModal.setTargetFragment(this, 1);
            fragmentModal.setArguments(bundle);
            FragmentTransaction ft = getActivity().getSupportFragmentManager().beginTransaction();
            fragmentModal.show(ft, "MovimentoNFeModalFragment");
        }
    }
}
