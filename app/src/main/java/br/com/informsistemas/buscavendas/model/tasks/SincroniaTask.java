...
public class SincroniaTask extends AsyncTask<String, Void, List<Atualizacao>> {
    ...
    protected List<Atualizacao> doInBackground(String... strings) {
        RequestSincAtualizacao requestSincAtualizacao = new RequestSincAtualizacao(Constants.DTO.registro.cnpj, Constants.DTO.registro.codigoconfiguracao, Constants.DTO.registro.codigoaplicacao);
