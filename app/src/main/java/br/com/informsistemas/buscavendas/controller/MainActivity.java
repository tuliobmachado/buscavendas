package br.com.informsistemas.buscavendas.controller;
...
import br.com.informsistemas.buscavendas.controller.fragments.MaterialSaldoFragment;
import br.com.informsistemas.buscavendas.fragments.MovimentoFragment;
import br.com.informsistemas.buscavendas.controller.fragments.ParceiroConsultaFragment;
import br.com.informsistemas.buscavendas.controller.fragments.RelatorioPedidoFragment;
import br.com.informsistemas.buscavendas.model.dao.DatabaseManager;
import br.com.informsistemas.buscavendas.model.dao.MaterialDAO;
import br.com.informsistemas.buscavendas.model.dao.RegistroDAO;
...
import br.com.informsistemas.buscavendas.model.utils.IOnBackPressed;
...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_iniciar_venda){
            ((MovimentoFragment) movimentoFragment).getSincronia(true);
        }else if (id == R.id.nav_finalizar_venda){
            apagarBanco();
            onSetItemMenu();
        }
    ...
    public void onShowPedido() {
        ...
        Constants.MOVIMENTO.movimento = new Movimento(Constants.MOVIMENTO.codigoempresa,
                ...
                null, "", new BigDecimal("0"), "", Misc.GetDateAtual(), null, null, null, new BigDecimal("0"), new BigDecimal("0"), Misc.gerarMD5(), "", "");
    ...
    public void onSetItemMenu() {
        ...
        if (MaterialDAO.getInstance(this).findFirst() != null){
            navigationView.getMenu().getItem(1).getSubMenu().getItem(0).setEnabled(false);
            navigationView.getMenu().getItem(1).getSubMenu().getItem(1).setEnabled(true);
        }else{
            navigationView.getMenu().getItem(1).getSubMenu().getItem(0).setEnabled(true);
