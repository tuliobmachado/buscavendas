...
import br.com.informsistemas.buscavendas.model.dao.FormaPagamentoDAO;
...
import br.com.informsistemas.buscavendas.model.utils.CPFCNPJMask;
...
public class ResumoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEnviarPedido.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                validarEnviarSalvarPedido(true);
            }
        });
        ...
        btnSalvarPedido.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                validarEnviarSalvarPedido(false);
            }
        });
    ...
    private void validarEnviarSalvarPedido(Boolean enviar){
        if (Constants.DTO.registro.obrigaobservacao && !edtTxtObservacao.getText().toString().equals("")) {
            enviarSalvarPedido(enviar);
        }else{
            Toast.makeText(ResumoActivity.this, "É obrigatório o preenchimento da observação!", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void getDadosFormaPagamentos() {
        ...
        if (Constants.PEDIDO.movimentoParcelas.size() > 0) {
