package br.com.informsistemas.buscavendas.controller.adapter;
...
public class MaterialSearchAdapter extends RecyclerView.Adapter<MaterialSearchAdapter.MyViewHolder>  {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, int position) {
        ...
        fList.get(position).saldodisponivel = MaterialSaldoDAO.getInstance(context).getSaldoDisponivel(fList.get(position).codigomaterial, fList.get(position).saldo);
        ...
        myViewHolder.txtSaldo.setText("Saldo: " + String.format("%.2f", fList.get(position).saldodisponivel) + " | " + fList.get(position).unidadesaida);
